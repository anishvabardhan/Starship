...
void HorizontalGBlur(uint x, uint y)
{
    uint2 inTextureDims;
    ...
    uint2 inPixel1UV = uint2(x + 1, y);
    uint2 inPixel2UV = uint2(x + 2, y);
    uint2 inPixel3UV = uint2(x + 3, y);
    uint2 inPixel4UV = uint2(x + 4, y);
    uint2 inPixel5UV = uint2(x + 5, y);
    uint2 inPixel6UV = uint2(x + 6, y);
    uint2 inPixel7UV = uint2(x + 7, y);
    uint2 inPixel8UV = uint2(x + 8, y);
    
    uint2 inPixel9UV = uint2(x - 1, y);
    uint2 inPixel10UV = uint2(x - 2, y);
    uint2 inPixel11UV = uint2(x - 3, y);
    uint2 inPixel12UV = uint2(x - 4, y);
    uint2 inPixel13UV = uint2(x - 5, y);
    uint2 inPixel14UV = uint2(x - 6, y);
    uint2 inPixel15UV = uint2(x - 7, y);
    uint2 inPixel16UV = uint2(x - 8, y);
